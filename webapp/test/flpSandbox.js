		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GR Odata",
									"targetURL": "#sapsyncprojectgr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapsyncprojectgr-display": {
								"semanticObject": "sapsyncprojectgr",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.sync.projectgr",
									"url": sap.ui.require.toUrl("sap/sync/projectgr")
								}
							}
						}
					}
